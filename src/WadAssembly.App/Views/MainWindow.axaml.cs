...
#pragma warning restore CS0618
    ...
    private static WindowIcon? LoadAppWindowIcon()
    {
        ...
        try
        {
            using var stream = AssetLoader.Open(new Uri("avares://WadAssembly.App/Assets/Sprite-0002.ico"));
    ...
    private static Bitmap? LoadAppImage()
    {
        ...
        try
        {
            using var stream = AssetLoader.Open(new Uri("avares://WadAssembly.App/Assets/Sprite-0002.png"));

...
namespace WadAssembly.Core.Localization;
...
public static class CoreMessages
{
    ...
    private static readonly Dictionary<string, string> Defaults = new()
    {
        ...
        ["Merge.AnimdefsGenerated"] = "Lump ANIMDEFS generado para {0} animación(es) numerada(s).",
        ["Merge.AnimatedLumpGenerated"] = "Lump ANIMATED generado para {0} animación(es) numerada(s).",
        ["Merge.SwitchesLumpGenerated"] = "Lump SWITCHES generado para {0} interruptor(es).",
        ["Merge.AnimatedRunTooLong"] = "Animación numerada {0}..{1} ({2} frames) supera el máximo de {3} frames que admiten los motores clásicos por animación; no se declara.",
        ["Merge.AnimatedRunNotConsecutive"] = "Animación numerada {0}..{1} no queda consecutiva en el WAD de salida; se omite del lump ANIMATED para evitar errores en Odamex/Boom.",
        ["Merge.NoAnimatedPrefixes"] = "No se declaran animaciones: la lista de prefijos a animar está vacía. Escribí los prefijos de las corridas que querés animar (p. ej. SHAWN, WATR).",
